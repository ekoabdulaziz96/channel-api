...
class AppCommerce:
    def __init__(self):
        self.headers = {"Content-Type": "application/json", "Api-Secret": settings.APP_COMMERCE_API_SECRET}
    ...
    def sync_channel(self, obj):
        ...
        self.data = {"store_slug": obj.store.slug, "name": obj.name, "slug": obj.slug, "types": obj.types}
